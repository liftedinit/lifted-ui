...
const variantStripe: PartsStyleFunction<typeof parts> = (props) => {
  ...
  return {
    th: {
      color: mode("lifted.gray.600", "lifted.gray.400")(props),
      borderBottom: "1px",
      borderColor: mode("lifted.gray.100", "lifted.gray.700")(props),
      ...numericStyles,
    },
    td: {
      borderBottom: "1px",
    ...
    tbody: {
      tr: {
        "&:nth-of-type(odd)": {
          ...
          td: {
            background: mode("lifted.gray.100", "lifted.gray.700")(props),
          },
        },
      },
    },
